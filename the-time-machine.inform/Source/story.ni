...
The description of Inside Dome is "Sunlight streams through the dome's oculus, illuminating the entire room. Low stone tables are arranged in a circular pattern around a large central well at the center of the dome. A series of murals circles the perimeter of the dome except for the exits. There is a small archway to the south and the main exit to the west."
...
The description of the River Bank is "[first time]The southeast path winds its way downhill through dense undergrowth. [only]After a brief hike, you emerge from the woods onto the northwest bank of a sizable river."

The illustration of River Bank is Figure of River Bank.
...
The description of the tunic is "[if the tunic is unfound]You can't see any such thing.[otherwise if the tunic is not part of the poker]A small Eloi tunic, untouched by blood, made up of a dense weave of cottony fibers.[otherwise]Wrapped around the end of the poker.[end if]"
...
To say release-notes:
	...
	- Added Emily Short's 'Bronze' exit display code to status bar with some modifications[line break]
	- Cleared screen and wait for Space press after being captured by Morlocks[paragraph break]
	- Removed Introduction Of Weena, Weena Give You Flower, and Morlock Endgame scenes.[line break]
	- Removed room code for Agora, Curia, Museum, Temple, Storeroom, Shaft 0, Shaft 5, Goggle Room, Power Plant.[line break]
	- Removed Gernsback code and responses from Ending Scene.[line break]
	- Removed Watchett movement code.[line break]
	- Removed player cigar, tobacco, and library papers from game.[line break]
	- Removed code for chandelier, tools, materials, workshop-tool-materials, and some blackboard code from game.[line break]
	- Removed code that provided details when reading books, periodicals, encyclopedias. Simplified fire, parts-of-fire, and kitchen code.[paragraph break]
	- Rewrote or reworked all of the descriptions related to rooms, objects, and scenery.[line break]
	- Fixed numerous spelling and punctuation errors.[line break]
	- Modified Game Introduction text.[line break]
	- Modified Introduction of Gernsback and Gernsback Leaves text.[line break]
	- Modified Morlock, Eloi, and Gernsback descriptions.[line break]
	- Created light/no light descriptions for Living Quarters and Catacombs.[line break]
	- Rewrote Travel To 802,701 description and displayed different text based on number of times traveled.[line break]
	- Varied text displayed when traveling back to 1895.[line break]
	- Added Gernsback Reveals Orrery Fuse and Gernsback Leaves scenes.[paragraph break]
	- Modified Weena's responses based on Underground or Outside location. Added better responses when following/not following you in Underground. Handled push/pull response to actions.[line break]
	- Modified Humboldt responses in Opening and Ending scenes, including Patience responses.[line break]
	- Consolidate Humboldt Exit responses into one text using conditionals.[line break]
	- Reworked Gernsback ask/tell responses.[line break]
	- Modified Watchett conversation code, particularly responses when asked about other people.[line break]
	- Added three response levels to >ask eloi about weena.[line break]
	- Fixed Eloi/River Bank/pocket watch response.[paragraph break]
	- Added additional synonyms for the following objects: ladder, metal cover, time machine, [time machine] controls, street area, and sideboard.[paragraph break]";
	say "
	- Made responses to attempt to drink river water conditional.[line break]
	- Prevented you from inserting things into well-water.[line break]
	- Handled attempts to cut bushes or undergrowth.[line break]
	- Handled trying to >take or >move time machine with custom response.[line break]
	- Handled >climb ladder in Top Well and Bottom Well.[line break]
	- Redirected >talk to <someone> as saying hello to.[line break]
	- Redirected >talk to|speak to <someone> about <any known thing> to quizzing it about.[line break]
	- Handled prying windows with objects other than poker.[line break]
	- Handled >push, >pull, and >climb gate.[line break]
	- Redirected >pull and >push windows to >open and >close windows.[line break]
	- Handled unlocking/locking windows 'with latch.'[line break]
	- Handled newspaper & fire/fireplace interactions.[line break]
	- Handled switching vs. searching orrery.[line break]
	- Redirected >enter house and >go in house to >go north.[line break]
	- Handled >read for readable objects in Library and Parlor. Differentiated shelf books from Gernsback’s book.[line break]
	- Handled dropping burning newspaper.[line break]
	- Added Morlock Defend rule.[paragraph break]
	- Fixed bug where you could sent time machine back to 1895 without you in machine.[line break]
	- Prevented you from sending empty time machine to 802,701 during Ending Scene.[line break]
	- Fixed bug where poker doesn’t appear in location when torch burns out.[line break]
	- Fixed time machine light/lever bug.[line break]
	- Added Desk Papers section.[line break]
	- Check if hinged panel is unlocked before trying to unlock it a second time.[line break]
	- Prevented you from putting anything but a fuse in orrery and time machine.[line break]
	- Added shapes so you can examine when Workshop lights are out.[line break]
	- Added Tunnel Collapse room and tunnel-collapse scenery.[line break]
	- Implemented armchair defaults in Parlor.[line break]
	- Created furniture class. Modified desk and chair in Library and dining table in Dining Room to use this class.[line break]
	- Made box of matches transparent.[line break]
	- Made Eloi disappear once Underground Exploration begins if they’re in the River Bank. Added conditional logic to Balcony based on this.[paragraph break]
	";
...
• Added code so Orrery and Time Machine work when working fuse inserted and don't work when not working fuse inserted.[paragraph break]";
